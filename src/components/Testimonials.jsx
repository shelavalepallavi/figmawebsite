...
const Testimonials = () => {
  return (
    <div className="testimonials">
      <div className="group">
        <div className="test1">
          <img src="https://github.com/shelavalepallavi/homevibes/quote.svg" alt="" />
          <p>
          ...
          <img className="person" src="https://github.com/shelavalepallavi/homevibes/test1.png" alt="person1" />
        ...
        <div className="test2">
          ...
          <img className="person" src="https://github.com/shelavalepallavi/homevibes/test2.png" alt="person2" />
          <span>Lora Smith </span>
        </div>
        <div className="test3">
          <img src="https://github.com/shelavalepallavi/homevibes/quote.svg" alt="" />
          ...
          <img className="person" src="https://github.com/shelavalepallavi/homevibes/test3.png" alt="person3" />
          <span>Lora Smith </span>
        </div>
      </div>
    </div>
