    ...
    <div className="testimonials">
      <div className="group">
        <div className="test1">
          ...
          <img className="person" src="src/assets/test1.png" alt="person1" />
        ...
        <div className="test2">
          ...
          <img className="person" src="src/assets/test2.png" alt="person2" />
          <span>Lora Smith </span>
        </div>
        <div className="test3">
          <img src="src/assets/quote.svg" alt="" />
          ...
          <img className="person" src="src/assets/test3.png" alt="person3" />
          <span>Lora Smith </span>
        </div>
      </div>
    </div>
